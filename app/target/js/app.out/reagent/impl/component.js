...
var _STAR_current_component_STAR_10908 = reagent.impl.component._STAR_current_component_STAR_;
...
break;
case (2):
var G__10910 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(1));
...
break;
case (4):
var G__10913 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(1));
var G__10914 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(2));
var G__10915 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(3));
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__10913,G__10914,G__10915) : f.call(null,G__10913,G__10914,G__10915));

break;
case (5):
var G__10916 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(1));
var G__10917 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(2));
var G__10918 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(3));
var G__10919 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(argv,(4));
return (f.cljs$core$IFn$_invoke$arity$4 ? f.cljs$core$IFn$_invoke$arity$4(G__10916,G__10917,G__10918,G__10919) : f.call(null,G__10916,G__10917,G__10918,G__10919));
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10908;
}});
...
var G__10930 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__10930) {
...
return ((function (G__10930){
return (function (){
var c = this;
var G__10931 = reagent.impl.component.state_atom(c);
var G__10932 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(c) : f.call(null,c));
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__10931,G__10932) : cljs.core.reset_BANG_.call(null,G__10931,G__10932));
});
;})(G__10930))
...
while (G__10941__i < G__10941__a.length) {G__10941__a[G__10941__i] = arguments[G__10941__i + 0]; ++G__10941__i;}
  args = new cljs.core.IndexedSeq(G__10941__a,0);
} 
...
var or__4988__auto__ = (function (){var and__4976__auto__ = cljs.core.fn_QMARK_(f);
...
var render_fun = (function (){var or__4988__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__4988__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fun_map);
if(cljs.core.truth_(or__4988__auto__)){
return or__4988__auto__;
} else {
...
var n = (function (){var G__10959 = reagent.impl.component._STAR_current_component_STAR_;
var G__10959__$1 = (((G__10959 == null))?null:(G__10959["cljsName"])());
return G__10959__$1;
})();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5760__auto__ = (function reagent$impl$component$shallow_obj_to_map_$_iter__10966(s__10967){
return (new cljs.core.LazySeq(null,(function (){
var s__10967__$1 = s__10967;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__10967__$1);
if(temp__4425__auto__){
var s__10967__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10967__$2)){
var c__5758__auto__ = cljs.core.chunk_first(s__10967__$2);
var size__5759__auto__ = cljs.core.count(c__5758__auto__);
var b__10969 = cljs.core.chunk_buffer(size__5759__auto__);
if((function (){var i__10968 = (0);
while(true){
if((i__10968 < size__5759__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5758__auto__,i__10968);
cljs.core.chunk_append(b__10969,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k])], null));

var G__10972 = (i__10968 + (1));
i__10968 = G__10972;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10969),reagent$impl$component$shallow_obj_to_map_$_iter__10966(cljs.core.chunk_rest(s__10967__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10969),null);
}
} else {
var k = cljs.core.first(s__10967__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k])], null),reagent$impl$component$shallow_obj_to_map_$_iter__10966(cljs.core.rest(s__10967__$2)));
}
} else {
return null;
}
...
return iter__5760__auto__(cljs.core.js_keys(o));
})());
});
