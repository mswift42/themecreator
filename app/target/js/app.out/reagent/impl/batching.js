...
var or__4990__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4990__auto__)){
return or__4990__auto__;
} else {
var or__4990__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4990__auto____$1)){
return or__4990__auto____$1;
} else {
var or__4990__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4990__auto____$2)){
return or__4990__auto____$2;
} else {
var or__4990__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4990__auto____$3)){
return or__4990__auto____$3;
} else {
...
var n__5893__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5893__auto__)){
var c_10886 = (a[i]);
if(cljs.core.truth_((c_10886["cljsIsDirty"]))){
(c_10886["forceUpdate"])();
} else {
}
...
var G__10889 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__10889) : reagent.impl.batching.next_tick.call(null,G__10889));
}
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5588__auto__,writer__5589__auto__,opt__5590__auto__){
return cljs.core._write(writer__5589__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__10891 = c;
var G__10891__$1 = (((G__10891 == null))?null:(G__10891["props"]));
if((G__10891__$1 == null)){
return null;
} else {
return (G__10891__$1["argv"]);
}
});
...
var G__10893_10894 = (c["cljsRatom"]);
if((G__10893_10894 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10893_10894);
}
