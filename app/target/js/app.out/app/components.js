...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$btn_DASH_group$themedrop,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,compid], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_default,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$type,"button"], null),title], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_default$dropdown_DASH_toggle,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,"button",cljs.core.cst$kw$data_DASH_toggle,"dropdown"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$caret], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$sr_DASH_only], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul$dropdown_DASH_menu,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$aria_DASH_labelledby,compid], null),(function (){var iter__5758__auto__ = (function app$components$select_component_$_iter__11446(s__11447){
return (new cljs.core.LazySeq(null,(function (){
var s__11447__$1 = s__11447;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__11447__$1);
if(temp__4425__auto__){
var s__11447__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__11447__$2)){
var c__5756__auto__ = cljs.core.chunk_first(s__11447__$2);
var size__5757__auto__ = cljs.core.count(c__5756__auto__);
var b__11449 = cljs.core.chunk_buffer(size__5757__auto__);
if((function (){var i__11448 = (0);
while(true){
if((i__11448 < size__5757__auto__)){
var vec__11454 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__5756__auto__,i__11448);
var linkhandler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11454,(0),null);
var linktitle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11454,(1),null);
cljs.core.chunk_append(b__11449,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$href,"#",cljs.core.cst$kw$on_DASH_click,linkhandler], null),linktitle], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,linkhandler], null)));

var G__11456 = (i__11448 + (1));
i__11448 = G__11456;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11449),app$components$select_component_$_iter__11446(cljs.core.chunk_rest(s__11447__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11449),null);
}
} else {
var vec__11455 = cljs.core.first(s__11447__$2);
var linkhandler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11455,(0),null);
var linktitle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11455,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$href,"#",cljs.core.cst$kw$on_DASH_click,linkhandler], null),linktitle], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,linkhandler], null)),app$components$select_component_$_iter__11446(cljs.core.rest(s__11447__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.components.select_component,"langdrop","Languages",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){
...
var sat_11463 = document.getElementById("saturationid").value;
var light_11464 = document.getElementById("lightnessid").value;
var G__11461_11465 = app.db.custom_palette_db;
var G__11462_11466 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$saturation,parseFloat(sat_11463),cljs.core.cst$kw$lightness,parseFloat(light_11464)], null);
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__11461_11465,G__11462_11466) : cljs.core.reset_BANG_.call(null,G__11461_11465,G__11462_11466));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$colorcomponent,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$row,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$label$colortitle$col_DASH_xs_DASH_4,cljs.core.name(facename)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$col_DASH_xs_DASH_3$colorinput$col_DASH_xs_DASH_offset_DASH_1,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,"color",cljs.core.cst$kw$value,(function (){var G__11471 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(app.db.app_db) : cljs.core.deref.call(null,app.db.app_db));
return (facename.cljs$core$IFn$_invoke$arity$1 ? facename.cljs$core$IFn$_invoke$arity$1(G__11471) : facename.call(null,G__11471));
})(),cljs.core.cst$kw$on_DASH_change,(function (p1__11467_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app.db.app_db,cljs.core.assoc,facename,p1__11467_SHARP_.target.value);
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$col_DASH_xs_DASH_3$textinput,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,"text",cljs.core.cst$kw$value,(function (){var G__11472 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(app.db.app_db) : cljs.core.deref.call(null,app.db.app_db));
return (facename.cljs$core$IFn$_invoke$arity$1 ? facename.cljs$core$IFn$_invoke$arity$1(G__11472) : facename.call(null,G__11472));
})(),cljs.core.cst$kw$on_DASH_change,(function (p1__11468_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app.db.app_db,cljs.core.assoc,facename,p1__11468_SHARP_.target.value);
})], null)], null)], null)], null);
});
app.components.name_component = (function app$components$name_component(){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$themename,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$row,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$label$colortitle$col_DASH_xs_DASH_5,[cljs.core.str("Themename")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$col_DASH_xs_DASH_4$textinput$col_DASH_xs_DASH_offset_DASH_1$nameinput,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,"text",cljs.core.cst$kw$value,cljs.core.cst$kw$themename.cljs$core$IFn$_invoke$arity$1((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(app.db.app_db) : cljs.core.deref.call(null,app.db.app_db))),cljs.core.cst$kw$on_DASH_change,(function (p1__11473_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app.db.app_db,cljs.core.assoc,cljs.core.cst$kw$themename,p1__11473_SHARP_.target.value);
})], null)], null)], null)], null);
});
app.components.author_component = (function app$components$author_component(){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$themename,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$row,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$label$colortitle$col_DASH_xs_DASH_5,[cljs.core.str("Author")].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$col_DASH_xs_DASH_4$textinput$col_DASH_xs_DASH_offset_DASH_1$nameinput,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,"text",cljs.core.cst$kw$value,cljs.core.cst$kw$themeauthor.cljs$core$IFn$_invoke$arity$1((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(app.db.app_db) : cljs.core.deref.call(null,app.db.app_db))),cljs.core.cst$kw$on_DASH_change,(function (p1__11474_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(app.db.app_db,cljs.core.assoc,cljs.core.cst$kw$themeauthor,p1__11474_SHARP_.target.value);
})], null)], null)], null)], null);
});
