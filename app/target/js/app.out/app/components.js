...
return cljs.core.chunk_cons(cljs.core.chunk(b__5868),app$components$select_component_$_iter__5865(cljs.core.chunk_rest(s__5866__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__5868),null);
}
} else {
var vec__5872 = cljs.core.first(s__5866__$2);
var linkhandler = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5872,(0),null);
var linktitle = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5872,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$href,"#",cljs.core.cst$kw$on_DASH_click,linkhandler], null),linktitle], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,linkhandler], null)),app$components$select_component_$_iter__5865(cljs.core.rest(s__5866__$2)));
}
} else {
return null;
}
...
var sat_5877 = document.getElementById("saturationid").value;
var light_5878 = document.getElementById("lightnessid").value;
cljs.core.reset_BANG_(app.db.custom_palette_db,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$saturation,parseFloat(sat_5877),cljs.core.cst$kw$lightness,parseFloat(light_5878)], null));
