...
var o22830 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22830["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22831 = temp__5733__auto____$1;
return (o22831["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22629__auto___22834 = t;
(o__22629__auto___22834["cljs$lang$ctorPrWriter"]).call(o__22629__auto___22834,t,writer);
}catch (e22833){var __22835 = e22833;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22836 = num_code;
switch (G__22836) {
case (1):
return (185);
...
}catch (e22838){var _e__22636__auto__ = e22838;
return false;
}})())){
...
var vec__22839 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22839,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o22842 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22842["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22843 = temp__5733__auto____$1;
return (o22843["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22850 = arguments.length;
var i__4731__auto___22851 = (0);
while(true){
if((i__4731__auto___22851 < len__4730__auto___22850)){
args__4736__auto__.push((arguments[i__4731__auto___22851]));

var G__22852 = (i__4731__auto___22851 + (1));
i__4731__auto___22851 = G__22852;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22846){
var vec__22847 = p__22846;
var ns_detector = cljs.core.nth.call(null,vec__22847,(0),null);
...
var G__22853 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22854 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22853;
remaining_tokens = G__22854;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22844){
...
var vec__22858 = cljs.core.split_with.call(null,(function (p1__22857_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22857_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22858,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22858,(1),null);
...
var vec__22864 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22864,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22864,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22867 = cljs.core.rest.call(null,remaining_tokens);
var G__22868 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22867;
name_tokens = G__22868;
continue;
} else {
...
var vec__22871 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22871,(0),null);
var arity = cljs.core.nth.call(null,vec__22871,(1),null);
var vec__22874 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22874,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22874,(1),null);
var vec__22877 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22877,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22877,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22877,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22877,(3),null);
...
var vec__22883 = result;
var munged_ns = cljs.core.nth.call(null,vec__22883,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22883,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22883,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22883,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22883,(4),null);
var arity = cljs.core.nth.call(null,vec__22883,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22887 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__22887,(0),null);
var args = cljs.core.nth.call(null,vec__22887,(1),null);
var vec__22890 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22890,(0),null);
var name = cljs.core.nth.call(null,vec__22890,(1),null);
...
var G__22893 = (arity + (1));
var G__22894 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22895){
var vec__22896 = p__22895;
var arity = cljs.core.nth.call(null,vec__22896,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22896,(1),null);
...
return cljs.core.get.call(null,arities,p1__22899_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22900_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___22907 = arguments.length;
var i__4731__auto___22908 = (0);
while(true){
if((i__4731__auto___22908 < len__4730__auto___22907)){
args__4736__auto__.push((arguments[i__4731__auto___22908]));

var G__22909 = (i__4731__auto___22908 + (1));
i__4731__auto___22908 = G__22909;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22903){
var vec__22904 = p__22903;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22904,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22901){
var G__22902 = cljs.core.first.call(null,seq22901);
var seq22901__$1 = cljs.core.next.call(null,seq22901);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22902,seq22901__$1);
});
...
var G__22910 = arg;
var G__22910__$1 = (((G__22910 instanceof cljs.core.Keyword))?G__22910.fqn:null);
switch (G__22910__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22912__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22912__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22912__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22912__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22913 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22913,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22913,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22913,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22913,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22913,(4),null);
var arity = cljs.core.nth.call(null,vec__22913,(5),null);
...
}catch (e22917){var _e__22636__auto__ = e22917;
...
var G__22918 = (obj[cljs.core.first.call(null,path)]);
var G__22919 = cljs.core.rest.call(null,path);
obj = G__22918;
path = G__22919;
continue;
} else {
...
return (function (accum,p__22920){
var vec__22921 = p__22920;
var bit = cljs.core.nth.call(null,vec__22921,(0),null);
var protocol = cljs.core.nth.call(null,vec__22921,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22924){
var vec__22925 = p__22924;
var ns = cljs.core.nth.call(null,vec__22925,(0),null);
var name = cljs.core.nth.call(null,vec__22925,(1),null);
var selector = cljs.core.nth.call(null,vec__22925,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22930,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22930,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22930,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22928_SHARP_){
return (obj[cljs.core.first.call(null,p1__22928_SHARP_)]);
});})(name,sorted_matches,vec__22930,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
