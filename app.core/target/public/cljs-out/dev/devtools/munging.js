...
var o21610 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21610["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21611 = temp__5733__auto____$1;
return (o21611["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__21427__auto___21614 = t;
(o__21427__auto___21614["cljs$lang$ctorPrWriter"]).call(o__21427__auto___21614,t,writer);
}catch (e21613){var __21615 = e21613;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21616 = num_code;
switch (G__21616) {
case (1):
return (185);
...
}catch (e21618){var _e__21434__auto__ = e21618;
return false;
}})())){
...
var vec__21619 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21619,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o21622 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21622["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o21623 = temp__5733__auto____$1;
return (o21623["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21626){
var vec__21627 = p__21626;
var ns_detector = cljs.core.nth.call(null,vec__21627,(0),null);
...
var G__21633 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21634 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21633;
remaining_tokens = G__21634;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21624){
...
var vec__21638 = cljs.core.split_with.call(null,(function (p1__21637_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21637_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21638,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21638,(1),null);
...
var vec__21644 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21644,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21644,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21647 = cljs.core.rest.call(null,remaining_tokens);
var G__21648 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21647;
name_tokens = G__21648;
continue;
} else {
...
var vec__21651 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21651,(0),null);
var arity = cljs.core.nth.call(null,vec__21651,(1),null);
var vec__21654 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21654,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21654,(1),null);
var vec__21657 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21657,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21657,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21657,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21657,(3),null);
...
var vec__21663 = result;
var munged_ns = cljs.core.nth.call(null,vec__21663,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21663,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21663,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21663,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21663,(4),null);
var arity = cljs.core.nth.call(null,vec__21663,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__21667 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__21667,(0),null);
var args = cljs.core.nth.call(null,vec__21667,(1),null);
var vec__21670 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21670,(0),null);
var name = cljs.core.nth.call(null,vec__21670,(1),null);
...
var G__21673 = (arity + (1));
var G__21674 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21675){
var vec__21676 = p__21675;
var arity = cljs.core.nth.call(null,vec__21676,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21676,(1),null);
...
return cljs.core.get.call(null,arities,p1__21679_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21680_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21683){
var vec__21684 = p__21683;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21684,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21681){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21692__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21692__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21692__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21692__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21693 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21693,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21693,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21693,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21693,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21693,(4),null);
var arity = cljs.core.nth.call(null,vec__21693,(5),null);
...
}catch (e21697){var _e__21434__auto__ = e21697;
...
var G__21698 = (obj[cljs.core.first.call(null,path)]);
var G__21699 = cljs.core.rest.call(null,path);
obj = G__21698;
path = G__21699;
continue;
} else {
...
return (function (accum,p__21700){
var vec__21701 = p__21700;
var bit = cljs.core.nth.call(null,vec__21701,(0),null);
var protocol = cljs.core.nth.call(null,vec__21701,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21704){
var vec__21705 = p__21704;
var ns = cljs.core.nth.call(null,vec__21705,(0),null);
var name = cljs.core.nth.call(null,vec__21705,(1),null);
var selector = cljs.core.nth.call(null,vec__21705,(2),null);
...
return (function (p__21709){
var vec__21710 = p__21709;
var munged_name = cljs.core.nth.call(null,vec__21710,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21710,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21710,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21708_SHARP_){
return (obj[cljs.core.first.call(null,p1__21708_SHARP_)]);
});})(name,sorted_matches,vec__21710,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
