...
var o15845 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15845["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15846 = temp__5733__auto____$1;
return (o15846["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15662__auto__ = f;
return (o__15662__auto__["toString"]).call(o__15662__auto__);
} else {
return "";
}
}catch (e15847){var _ = e15847;
return "";
}});
...
try{var o__15662__auto___15849 = t;
(o__15662__auto___15849["cljs$lang$ctorPrWriter"]).call(o__15662__auto___15849,t,writer);
}catch (e15848){var __15850 = e15848;
}
...
var char_code = (function (){var o__15662__auto__ = (new String(char$));
return (o__15662__auto__["charCodeAt"]).call(o__15662__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15662__auto__ = String;
return (o__15662__auto__["fromCharCode"]).call(o__15662__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15851 = num_code;
switch (G__15851) {
case (1):
return (185);
...
var o__15662__auto__ = String;
return (o__15662__auto__["fromCharCode"]).call(o__15662__auto__,superscript_code);
});
/**
...
}catch (e15853){var _e__15669__auto__ = e15853;
return false;
}})())){
...
var vec__15854 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15854,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o15857 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15857["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15858 = temp__5733__auto____$1;
return (o15858["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15861){
var vec__15862 = p__15861;
var ns_detector = cljs.core.nth.call(null,vec__15862,(0),null);
...
var G__15868 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15869 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15868;
remaining_tokens = G__15869;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15859){
var G__15860 = cljs.core.first.call(null,seq15859);
var seq15859__$1 = cljs.core.next.call(null,seq15859);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15860,seq15859__$1);
});
...
var vec__15873 = cljs.core.split_with.call(null,(function (p1__15872_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15872_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15873,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15873,(1),null);
...
var vec__15879 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15879,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15879,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15882 = cljs.core.rest.call(null,remaining_tokens);
var G__15883 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15882;
name_tokens = G__15883;
continue;
} else {
...
var vec__15886 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15886,(0),null);
var arity = cljs.core.nth.call(null,vec__15886,(1),null);
var vec__15889 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15889,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15889,(1),null);
var vec__15892 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15892,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15892,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15892,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15892,(3),null);
...
var vec__15898 = result;
var munged_ns = cljs.core.nth.call(null,vec__15898,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15898,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15898,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15898,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15898,(4),null);
var arity = cljs.core.nth.call(null,vec__15898,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__15902 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__15902,(0),null);
var args = cljs.core.nth.call(null,vec__15902,(1),null);
var vec__15905 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15905,(0),null);
...
var G__15908 = (arity + (1));
var G__15909 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15910){
var vec__15911 = p__15910;
var arity = cljs.core.nth.call(null,vec__15911,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15911,(1),null);
...
return cljs.core.get.call(null,arities,p1__15914_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15915_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15918){
var vec__15919 = p__15918;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15919,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15916){
var G__15917 = cljs.core.first.call(null,seq15916);
var seq15916__$1 = cljs.core.next.call(null,seq15916);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15917,seq15916__$1);
});
...
var G__15925 = arg;
var G__15925__$1 = (((G__15925 instanceof cljs.core.Keyword))?G__15925.fqn:null);
switch (G__15925__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15927__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15927__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15927__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15927__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15928 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15928,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15928,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15928,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15928,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15928,(4),null);
var arity = cljs.core.nth.call(null,vec__15928,(5),null);
...
var o__15662__auto__ = f;
return (o__15662__auto__["getBasis"]).call(o__15662__auto__);
});
/**
...
}catch (e15932){var _e__15669__auto__ = e15932;
...
var G__15933 = (obj[cljs.core.first.call(null,path)]);
var G__15934 = cljs.core.rest.call(null,path);
obj = G__15933;
path = G__15934;
continue;
} else {
...
return (function (accum,p__15935){
var vec__15936 = p__15935;
var bit = cljs.core.nth.call(null,vec__15936,(0),null);
var protocol = cljs.core.nth.call(null,vec__15936,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15939){
var vec__15940 = p__15939;
var ns = cljs.core.nth.call(null,vec__15940,(0),null);
var name = cljs.core.nth.call(null,vec__15940,(1),null);
var selector = cljs.core.nth.call(null,vec__15940,(2),null);
...
return (function (p__15944){
var vec__15945 = p__15944;
var munged_name = cljs.core.nth.call(null,vec__15945,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15945,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15945,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15943_SHARP_){
return (obj[cljs.core.first.call(null,p1__15943_SHARP_)]);
});})(name,sorted_matches,vec__15945,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
