...
var o28210 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28210["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28211 = temp__5733__auto____$1;
return (o28211["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17123__auto__ = f;
return (o__17123__auto__["toString"]).call(o__17123__auto__);
} else {
return "";
}
}catch (e28212){var _ = e28212;
return "";
}});
...
try{var o__17123__auto___28214 = t;
(o__17123__auto___28214["cljs$lang$ctorPrWriter"]).call(o__17123__auto___28214,t,writer);
}catch (e28213){var __28215 = e28213;
}
...
var char_code = (function (){var o__17123__auto__ = (new String(char$));
return (o__17123__auto__["charCodeAt"]).call(o__17123__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17123__auto__ = String;
return (o__17123__auto__["fromCharCode"]).call(o__17123__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28216 = num_code;
switch (G__28216) {
case (1):
return (185);
...
var o__17123__auto__ = String;
return (o__17123__auto__["fromCharCode"]).call(o__17123__auto__,superscript_code);
});
/**
...
}catch (e28218){var _e__17130__auto__ = e28218;
return false;
}})())){
...
var vec__28219 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28219,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28222 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28222["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28223 = temp__5733__auto____$1;
return (o28223["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28226){
var vec__28227 = p__28226;
var ns_detector = cljs.core.nth.call(null,vec__28227,(0),null);
...
var G__28233 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28234 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28233;
remaining_tokens = G__28234;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28224){
var G__28225 = cljs.core.first.call(null,seq28224);
var seq28224__$1 = cljs.core.next.call(null,seq28224);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28225,seq28224__$1);
});
...
var vec__28238 = cljs.core.split_with.call(null,(function (p1__28237_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28237_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28238,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28238,(1),null);
...
var vec__28244 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28244,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28244,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28247 = cljs.core.rest.call(null,remaining_tokens);
var G__28248 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28247;
name_tokens = G__28248;
continue;
} else {
...
var vec__28251 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28251,(0),null);
var arity = cljs.core.nth.call(null,vec__28251,(1),null);
var vec__28254 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28254,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28254,(1),null);
var vec__28257 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28257,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28257,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28257,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28257,(3),null);
...
var munged_ns = cljs.core.nth.call(null,vec__28263,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28263,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28263,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28263,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28263,(4),null);
var arity = cljs.core.nth.call(null,vec__28263,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28267 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__28267,(0),null);
var args = cljs.core.nth.call(null,vec__28267,(1),null);
var vec__28270 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28270,(0),null);
var name = cljs.core.nth.call(null,vec__28270,(1),null);
...
var G__28273 = (arity + (1));
var G__28274 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28275){
var vec__28276 = p__28275;
var arity = cljs.core.nth.call(null,vec__28276,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28276,(1),null);
...
return cljs.core.get.call(null,arities,p1__28279_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28280_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28283){
var vec__28284 = p__28283;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28284,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28281){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28292__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28292__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28292__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28292__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28293 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28293,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28293,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28293,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28293,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28293,(4),null);
var arity = cljs.core.nth.call(null,vec__28293,(5),null);
...
var o__17123__auto__ = f;
return (o__17123__auto__["getBasis"]).call(o__17123__auto__);
});
/**
...
}catch (e28297){var _e__17130__auto__ = e28297;
...
var G__28298 = (obj[cljs.core.first.call(null,path)]);
var G__28299 = cljs.core.rest.call(null,path);
obj = G__28298;
path = G__28299;
continue;
} else {
...
return (function (accum,p__28300){
var vec__28301 = p__28300;
var bit = cljs.core.nth.call(null,vec__28301,(0),null);
var protocol = cljs.core.nth.call(null,vec__28301,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28304){
var vec__28305 = p__28304;
var ns = cljs.core.nth.call(null,vec__28305,(0),null);
var name = cljs.core.nth.call(null,vec__28305,(1),null);
var selector = cljs.core.nth.call(null,vec__28305,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28310,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28310,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28310,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28308_SHARP_){
return (obj[cljs.core.first.call(null,p1__28308_SHARP_)]);
});})(name,sorted_matches,vec__28310,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
