...
var G__16419 = devtools.prefs.pref.call(null,v);
v = G__16419;
continue;
} else {
return v;
...
}catch (e16422){var _e__15669__auto__ = e16422;
return false;
}})();
...
}catch (e16426){var _e__15669__auto__ = e16426;
return false;
}})();
...
}catch (e16428){var _e__15669__auto__ = e16428;
return false;
}}
}
});
...
var vec__16430 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16430,(0),null);
var name = cljs.core.nth.call(null,vec__16430,(1),null);
...
return cljs.core.some.call(null,(function (p1__16433_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16433_SHARP_);
}),template);
});
