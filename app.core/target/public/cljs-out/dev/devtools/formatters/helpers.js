...
var G__22184 = devtools.prefs.pref.call(null,v);
v = G__22184;
continue;
} else {
return v;
...
}catch (e22187){var _e__21434__auto__ = e22187;
return false;
}})();
...
}catch (e22191){var _e__21434__auto__ = e22191;
return false;
}})();
...
}catch (e22193){var _e__21434__auto__ = e22193;
return false;
}}
}
});
...
var vec__22195 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22195,(0),null);
var name = cljs.core.nth.call(null,vec__22195,(1),null);
...
return cljs.core.some.call(null,(function (p1__22198_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22198_SHARP_);
}),template);
});
