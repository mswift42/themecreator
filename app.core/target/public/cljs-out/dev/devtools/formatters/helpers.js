...
var G__28333 = devtools.prefs.pref.call(null,v);
v = G__28333;
continue;
} else {
return v;
...
}catch (e28336){var _e__17130__auto__ = e28336;
return false;
}})();
...
}catch (e28340){var _e__17130__auto__ = e28340;
return false;
}})();
...
}catch (e28342){var _e__17130__auto__ = e28342;
return false;
}}
}
});
...
var vec__28344 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28344,(0),null);
var name = cljs.core.nth.call(null,vec__28344,(1),null);
...
return cljs.core.some.call(null,(function (p1__28347_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28347_SHARP_);
}),template);
});
