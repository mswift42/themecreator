...
var len__4864__auto___11038 = arguments.length;
var i__4865__auto___11039 = (0);
while(true){
if((i__4865__auto___11039 < len__4864__auto___11038)){
args__4870__auto__.push((arguments[i__4865__auto___11039]));

var G__11040 = (i__4865__auto___11039 + (1));
i__4865__auto___11039 = G__11040;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11035){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11036,G__11037,seq11035__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11041_SHARP_){
return (!((cljs.core.meta.call(null,p1__11041_SHARP_) == null)));
})))){
...
var map__11042 = opts;
var map__11042__$1 = cljs.core.__destructure_map.call(null,map__11042);
var markup_db = cljs.core.get.call(null,map__11042__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11043){var _e__10051__auto__ = e11043;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11045){var _e__10051__auto__ = e11045;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11047 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11048 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11048);
...
var markup_db = cljs.core.get.call(null,map__11049__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11047);
}});
...
var temp__5751__auto___11053 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___11053)){
var managed_print_level_11054 = temp__5751__auto___11053;
var _STAR_print_level_STAR__orig_val__11051_11055 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11052_11056 = managed_print_level_11054;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11052_11056);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__11050_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11050_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11051_11055);
}} else {
job_fn.call(null);
}
