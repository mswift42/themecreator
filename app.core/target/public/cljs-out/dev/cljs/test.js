...
var G__11181 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11181,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11181;
}
}));
...
var len__4864__auto___11186 = arguments.length;
var i__4865__auto___11187 = (0);
while(true){
if((i__4865__auto___11187 < len__4864__auto___11186)){
args__4870__auto__.push((arguments[i__4865__auto___11187]));

var G__11188 = (i__4865__auto___11187 + (1));
i__4865__auto___11187 = G__11188;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11183){
...
var map__11190 = m;
var map__11190__$1 = cljs.core.__destructure_map.call(null,map__11190);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11189_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11189_SHARP_));
...
var temp__5753__auto___11191 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___11191)){
var message_11192 = temp__5753__auto___11191;
cljs.core.println.call(null,message_11192);
} else {
}
...
var temp__5753__auto___11193 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___11193)){
var message_11194 = temp__5753__auto___11193;
cljs.core.println.call(null,message_11194);
} else {
}
...
var output_dir__$1 = (function (){var G__11195 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11195,"/"].join('');
} else {
return G__11195;
}
})();
...
var G__11196 = exception.stack;
var G__11196__$1 = (((G__11196 == null))?null:clojure.string.split_lines.call(null,G__11196));
var G__11196__$2 = (((G__11196__$1 == null))?null:cljs.core.get.call(null,G__11196__$1,depth));
if((G__11196__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11196__$2);
}
} else {
...
var vec__11197 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11197,(0),null);
var column = cljs.core.nth.call(null,vec__11197,(1),null);
var vec__11200 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11200,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11200,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11200,(2),null);
...
var m__$1 = (function (){var G__11203 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11207 = (function (){var G__11206 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11206);
} else {
return G__11206;
}
})();
...
return cljs.core.vary_meta.call(null,G__11208,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11212 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11212,(0),null);
var types = vec__11212;
...
return cljs.core.map.call(null,(function (p__11215){
var vec__11216 = p__11215;
var ns = cljs.core.nth.call(null,vec__11216,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11216,(1),null);
return (function (){
...
var G__11219 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__11220 = cljs.core.seq.call(null,vars__$1);
var chunk__11221 = null;
var count__11222 = (0);
var i__11223 = (0);
while(true){
if((i__11223 < count__11222)){
var v = cljs.core._nth.call(null,chunk__11221,i__11223);
var temp__5753__auto___11225 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___11225)){
var t_11226 = temp__5753__auto___11225;
each_fixture_fn.call(null,((function (seq__11220,chunk__11221,count__11222,i__11223,t_11226,temp__5753__auto___11225,v,each_fixture_fn,G__11219,G__11219__$1,env,once_fixtures,each_fixtures,vec__11216,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11226)));
});})(seq__11220,chunk__11221,count__11222,i__11223,t_11226,temp__5753__auto___11225,v,each_fixture_fn,G__11219,G__11219__$1,env,once_fixtures,each_fixtures,vec__11216,ns,vars__$1))
);
} else {
}


var G__11227 = seq__11220;
var G__11228 = chunk__11221;
var G__11229 = count__11222;
var G__11230 = (i__11223 + (1));
seq__11220 = G__11227;
chunk__11221 = G__11228;
count__11222 = G__11229;
i__11223 = G__11230;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq.call(null,seq__11220);
if(temp__5753__auto__){
var seq__11220__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11220__$1)){
var c__4679__auto__ = cljs.core.chunk_first.call(null,seq__11220__$1);
var G__11231 = cljs.core.chunk_rest.call(null,seq__11220__$1);
var G__11232 = c__4679__auto__;
var G__11233 = cljs.core.count.call(null,c__4679__auto__);
var G__11234 = (0);
seq__11220 = G__11231;
chunk__11221 = G__11232;
count__11222 = G__11233;
i__11223 = G__11234;
continue;
} else {
var v = cljs.core.first.call(null,seq__11220__$1);
var temp__5753__auto___11235__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5753__auto___11235__$1)){
var t_11236 = temp__5753__auto___11235__$1;
each_fixture_fn.call(null,((function (seq__11220,chunk__11221,count__11222,i__11223,t_11236,temp__5753__auto___11235__$1,v,seq__11220__$1,temp__5753__auto__,each_fixture_fn,G__11219,G__11219__$1,env,once_fixtures,each_fixtures,vec__11216,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11236)));
});})(seq__11220,chunk__11221,count__11222,i__11223,t_11236,temp__5753__auto___11235__$1,v,seq__11220__$1,temp__5753__auto__,each_fixture_fn,G__11219,G__11219__$1,env,once_fixtures,each_fixtures,vec__11216,ns,vars__$1))
);
} else {
}


var G__11237 = cljs.core.next.call(null,seq__11220__$1);
var G__11238 = null;
var G__11239 = (0);
var G__11240 = (0);
seq__11220 = G__11237;
chunk__11221 = G__11238;
count__11222 = G__11239;
i__11223 = G__11240;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11219__$1)].join('')));
