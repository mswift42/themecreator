...
var G__21247 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21247,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21247;
}
});
...
var len__4730__auto___21252 = arguments.length;
var i__4731__auto___21253 = (0);
while(true){
if((i__4731__auto___21253 < len__4730__auto___21252)){
args__4736__auto__.push((arguments[i__4731__auto___21253]));

var G__21254 = (i__4731__auto___21253 + (1));
i__4731__auto___21253 = G__21254;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21249){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21250,G__21251,seq21249__$2);
});
...
var file = cljs.core.get.call(null,map__21256__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21256__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21256__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21256,map__21256__$1,file,line,column){
return (function (p1__21255_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21255_SHARP_));
});})(map__21256,map__21256__$1,file,line,column))
...
var temp__5735__auto___21258 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___21258)){
var message_21259 = temp__5735__auto___21258;
cljs.core.println.call(null,message_21259);
} else {
}
...
var temp__5735__auto___21260 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___21260)){
var message_21261 = temp__5735__auto___21260;
cljs.core.println.call(null,message_21261);
} else {
}
...
var output_dir__$1 = (function (){var G__21262 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__21262,"/"].join('');
} else {
return G__21262;
}
})();
...
var G__21264 = exception.stack;
var G__21264__$1 = (((G__21264 == null))?null:clojure.string.split_lines.call(null,G__21264));
var G__21264__$2 = (((G__21264__$1 == null))?null:cljs.core.get.call(null,G__21264__$1,depth));
if((G__21264__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21264__$2);
}
} else {
...
var vec__21265 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21265,(0),null);
var column = cljs.core.nth.call(null,vec__21265,(1),null);
var vec__21268 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21268,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21268,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21268,(2),null);
...
var m__$1 = (function (){var G__21271 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21275 = (function (){var G__21274 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21274);
} else {
return G__21274;
}
})();
...
return cljs.core.vary_meta.call(null,G__21276,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21280 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21280,(0),null);
var types = vec__21280;
...
return cljs.core.map.call(null,(function (p__21283){
var vec__21284 = p__21283;
var ns = cljs.core.nth.call(null,vec__21284,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21284,(1),null);
return ((function (vec__21284,ns,vars__$1){
return (function (){
...
var G__21287 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1){
return (function (){
var seq__21288 = cljs.core.seq.call(null,vars__$1);
var chunk__21289 = null;
var count__21290 = (0);
var i__21291 = (0);
while(true){
if((i__21291 < count__21290)){
var v = cljs.core._nth.call(null,chunk__21289,i__21291);
var temp__5735__auto___21293 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___21293)){
var t_21294 = temp__5735__auto___21293;
each_fixture_fn.call(null,((function (seq__21288,chunk__21289,count__21290,i__21291,t_21294,temp__5735__auto___21293,v,each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21294)));
});})(seq__21288,chunk__21289,count__21290,i__21291,t_21294,temp__5735__auto___21293,v,each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1))
);
} else {
}


var G__21295 = seq__21288;
var G__21296 = chunk__21289;
var G__21297 = count__21290;
var G__21298 = (i__21291 + (1));
seq__21288 = G__21295;
chunk__21289 = G__21296;
count__21290 = G__21297;
i__21291 = G__21298;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__21288);
if(temp__5735__auto__){
var seq__21288__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21288__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__21288__$1);
var G__21299 = cljs.core.chunk_rest.call(null,seq__21288__$1);
var G__21300 = c__4550__auto__;
var G__21301 = cljs.core.count.call(null,c__4550__auto__);
var G__21302 = (0);
seq__21288 = G__21299;
chunk__21289 = G__21300;
count__21290 = G__21301;
i__21291 = G__21302;
continue;
} else {
var v = cljs.core.first.call(null,seq__21288__$1);
var temp__5735__auto___21303__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___21303__$1)){
var t_21304 = temp__5735__auto___21303__$1;
each_fixture_fn.call(null,((function (seq__21288,chunk__21289,count__21290,i__21291,t_21304,temp__5735__auto___21303__$1,v,seq__21288__$1,temp__5735__auto__,each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21304)));
});})(seq__21288,chunk__21289,count__21290,i__21291,t_21304,temp__5735__auto___21303__$1,v,seq__21288__$1,temp__5735__auto__,each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1))
);
} else {
}


var G__21305 = cljs.core.next.call(null,seq__21288__$1);
var G__21306 = null;
var G__21307 = (0);
var G__21308 = (0);
seq__21288 = G__21305;
chunk__21289 = G__21306;
count__21290 = G__21307;
i__21291 = G__21308;
continue;
}
} else {
...
});})(each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1))
);
});})(each_fixture_fn,G__21287,G__21287__$1,env,once_fixtures,each_fixtures,vec__21284,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21287__$1)].join('')));

}
})());
});
;})(vec__21284,ns,vars__$1))
