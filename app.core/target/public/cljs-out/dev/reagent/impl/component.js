...
if((i < len)){
var k = (ks[i]);
var G__13564 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__13565 = (i + (1));
m = G__13564;
i = G__13565;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13566 = p.children;
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__13566) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__13566));
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13568 = c;
var G__13568__$1 = (((G__13568 == null))?null:G__13568.prototype);
if((G__13568__$1 == null)){
return null;
} else {
return G__13568__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13570 = c;
var G__13570__$1 = (((G__13570 == null))?null:G__13570.prototype);
if((G__13570__$1 == null)){
return null;
} else {
return G__13570__$1.render;
}
})() == null)))));
});
...
var G__13572 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13572) : reagent.impl.component.as_element.call(null,G__13572));
};
...
var _STAR_current_component_STAR__orig_val__13578 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13579 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13579;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13578;
}});
...
return ((function (G__13580,G__13580__$1){
...
var c = this;
var G__13585_13587 = goog.object.get(c,"cljsRatom");
if((G__13585_13587 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13585_13587);
}
...
var renders_13588 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_13589 = cljs.core.first(cljs.core.vals(renders_13588));
...
if((cljs.core.count(renders_13588) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13588))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13589)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13589], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13590 = o;
var G__13591_13594 = G__13590;
var G__13592_13595 = cljs.core.name(k);
var G__13593_13596 = v;
goog.object.set(G__13591_13594,G__13592_13595,G__13593_13596);
...
;
var G__13597_13600 = cmp.prototype;
var G__13598_13601 = reagent.impl.component.global$module$react.Component.prototype;
var G__13599_13602 = methods$;
goog.object.extend(G__13597_13600,G__13598_13601,G__13599_13602);
...
var name = (function (){var G__13603 = fiber;
var G__13603__$1 = (((G__13603 == null))?null:G__13603.type);
if((G__13603__$1 == null)){
return null;
} else {
return G__13603__$1.displayName;
}
})();
var parent = (function (){var G__13604 = fiber;
if((G__13604 == null)){
return null;
} else {
return G__13604.return;
}
})();
var path = (function (){var G__13605 = parent;
var G__13605__$1 = (((G__13605 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__13605) : reagent.impl.component.fiber_component_path.call(null,G__13605)));
if((G__13605__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13605__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__13607 = c;
if((G__13607 == null)){
return null;
} else {
return goog.object.get(G__13607,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__13608._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__13610 = c;
if((G__13610 == null)){
return null;
} else {
return goog.object.get(G__13610,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__13612 = c;
if((G__13612 == null)){
return null;
} else {
...
var elem = (function (){var or__4131__auto__ = (function (){var G__13614 = instance;
if((G__13614 == null)){
return null;
} else {
return goog.object.get(G__13614,"_currentElement");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__13615 = instance;
if((G__13615 == null)){
return null;
} else {
return G__13615._currentElement;
}
}
})();
var name = (function (){var G__13616 = elem;
var G__13616__$1 = (((G__13616 == null))?null:G__13616.type);
if((G__13616__$1 == null)){
return null;
} else {
return G__13616__$1.displayName;
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__13618 = elem;
if((G__13618 == null)){
return null;
} else {
return goog.object.get(G__13618,"_owner");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__13619._owner;
}
}
})();
var path = (function (){var G__13620 = owner;
var G__13620__$1 = (((G__13620 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__13620) : reagent.impl.component.component_path.call(null,G__13620)));
if((G__13620__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13620__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__13621 = c;
var G__13621__$1 = (((G__13621 == null))?null:G__13621.constructor);
if((G__13621__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13621__$1);
}
}
})();
