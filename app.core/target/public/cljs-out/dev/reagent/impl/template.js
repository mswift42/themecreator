...
var G__17799 = o;
goog.object.set(G__17799,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__17803 = o;
goog.object.set(G__17803,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__17804__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__17805__i < G__17805__a.length) {G__17805__a[G__17805__i] = arguments[G__17805__i + 0]; ++G__17805__i;}
  args = new cljs.core.IndexedSeq(G__17805__a,0,null);
} 
return G__17804__delegate.call(this,args);};
...
return G__17804__delegate(args);
});
...
var G__17807 = props;
var G__17807__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17807,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17807);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17807__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__17807__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__17808 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17808,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__17808;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__17809){
...
var on_write = cljs.core.get.call(null,map__17810__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__17810,map__17810__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__17810,map__17810__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17812_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__17815 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17815,(0),null);
var id = cljs.core.nth.call(null,vec__17815,(1),null);
var className = cljs.core.nth.call(null,vec__17815,(2),null);
...
var temp__5739__auto___17819 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___17819 == null)){
} else {
var key_17820 = temp__5739__auto___17819;
jsprops.key = key_17820;
}
...
var temp__5739__auto___17821 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___17821 == null)){
} else {
var key_17822 = temp__5739__auto___17821;
jsprops.key = key_17822;
}
...
var temp__5739__auto___17823 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___17823 == null)){
} else {
var key_17824 = temp__5739__auto___17823;
jsprops.key = key_17824;
}
...
var G__17826 = n;
if(cljs.core._EQ_.call(null,"",G__17826)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__17826)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17827){
var G__17828 = cljs.core.first.call(null,seq17827);
var seq17827__$1 = cljs.core.next.call(null,seq17827);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17828,seq17827__$1);
});
...
break;
default:
var G__17834 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__17834;
continue;
...
var ctx = ({});
var vec__17836 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__17836,(0),null);
var derefed = cljs.core.nth.call(null,vec__17836,(1),null);
...
var G__17839 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17839) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__17839){
