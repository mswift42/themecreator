...
var G__23805 = o;
goog.object.set(G__23805,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__23806__delegate = function (args){
...
while (G__23807__i < G__23807__a.length) {G__23807__a[G__23807__i] = arguments[G__23807__i + 0]; ++G__23807__i;}
  args = new cljs.core.IndexedSeq(G__23807__a,0,null);
} 
return G__23806__delegate.call(this,args);};
...
return G__23806__delegate(args);
});
...
var G__23809 = o;
goog.object.set(G__23809,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__23811__i < G__23811__a.length) {G__23811__a[G__23811__i] = arguments[G__23811__i + 0]; ++G__23811__i;}
  args = new cljs.core.IndexedSeq(G__23811__a,0,null);
} 
...
var G__23813 = props;
var G__23813__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__23813,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23813);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__23813__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__23813__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__23814 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__23814,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__23814;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__23815){
var map__23816 = p__23815;
var map__23816__$1 = (((((!((map__23816 == null))))?(((((map__23816.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23816.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23816):map__23816);
var on_write = cljs.core.get.call(null,map__23816__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__23816,map__23816__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__23816,map__23816__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23818_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__23821 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23821,(0),null);
var id = cljs.core.nth.call(null,vec__23821,(1),null);
var className = cljs.core.nth.call(null,vec__23821,(2),null);
...
var temp__5739__auto___23825 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___23825 == null)){
} else {
var key_23826 = temp__5739__auto___23825;
...
var temp__5739__auto___23827 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___23827 == null)){
} else {
var key_23828 = temp__5739__auto___23827;
...
var temp__5739__auto___23829 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___23829 == null)){
} else {
var key_23830 = temp__5739__auto___23829;
...
var G__23832 = n;
if(cljs.core._EQ_.call(null,"",G__23832)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__23832)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23833){
...
break;
default:
var G__23840 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__23840;
continue;
...
var ctx = ({});
var vec__23842 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23842,(0),null);
var derefed = cljs.core.nth.call(null,vec__23842,(1),null);
...
var G__23845 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23845) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__23845){
