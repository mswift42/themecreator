...
return cljs.core.map.call(null,(function (p1__21231_SHARP_){
return html_coll.item(p1__21231_SHARP_);
...
return cljs.core.some.call(null,(function (p1__21232_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__21232_SHARP_);
...
var ctx_21233 = cvs.getContext("2d");
(ctx_21233.fillStyle = color);

ctx_21233.fillRect((0),(0),size,size);
