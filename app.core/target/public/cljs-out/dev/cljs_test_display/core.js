...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10740){
var G__10741 = cljs.core.first.call(null,seq10740);
var seq10740__$1 = cljs.core.next.call(null,seq10740);
var G__10742 = cljs.core.first.call(null,seq10740__$1);
var seq10740__$2 = cljs.core.next.call(null,seq10740__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10741,G__10742,seq10740__$2);
});
...
var vec__10746 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10746,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10746,(1),null);
var G__10749 = cljs.core.PersistentArrayMap.EMPTY;
var G__10749__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10749,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10749);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10749__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10749__$1;
}
} else {
...
return (function() { 
var G__10753__delegate = function (klass,contents){
var vec__10750 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10750,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10750,(1),null);
...
var G__10753 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__10754__i = 0, G__10754__a = new Array(arguments.length -  1);
while (G__10754__i < G__10754__a.length) {G__10754__a[G__10754__i] = arguments[G__10754__i + 1]; ++G__10754__i;}
  contents = new cljs.core.IndexedSeq(G__10754__a,0,null);
} 
return G__10753__delegate.call(this,klass,contents);};
G__10753.cljs$lang$maxFixedArity = 1;
G__10753.cljs$lang$applyTo = (function (arglist__10755){
var klass = cljs.core.first(arglist__10755);
var contents = cljs.core.rest(arglist__10755);
return G__10753__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10759){
...
var ns = cljs.core.get.call(null,map__10760__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__10760__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10762){
...
var actual = cljs.core.get.call(null,map__10763__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10763__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10765){
...
var expected = cljs.core.get.call(null,map__10766__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10766__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10768_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10770 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__10770__$1;
var name = cljs.core.get.call(null,map__10770__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__10770__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__10770__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10770,map__10770__$1,info,name,line,file,node){
return (function (p1__10769_SHARP_){
return cljs.core.cons.call(null,node,p1__10769_SHARP_);
});})(curr_node,map__10770,map__10770__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10772){
...
var m = map__10773__$1;
var fail = cljs.core.get.call(null,map__10773__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10773__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10773__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10773__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___10775 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10775)){
var message_10776 = temp__5457__auto___10775;
cljs.core.println.call(null,message_10776);
} else {
}
...
var temp__5457__auto___10777 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10777)){
var message_10778 = temp__5457__auto___10777;
cljs.core.println.call(null,message_10778);
} else {
}
