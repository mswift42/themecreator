...
return cljs.core.reduce.call(null,(function (result,p__12277){
...
var vec__12281 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__12281,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__12281,(1),null);
var ab = cljs.core.nth.call(null,vec__12281,(2),null);
...
return clojure$data$EqualityPartition$equality_partition$dyn_12287.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_12288 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_12288.call(null,a,b);
}
});
...
return (function (){var G__12292 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12292__$1)].join('')));
