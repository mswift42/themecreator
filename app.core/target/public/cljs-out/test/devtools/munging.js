...
var o12108 = temp__5751__auto__;
var temp__5751__auto____$1 = (o12108["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o12109 = temp__5751__auto____$1;
return (o12109["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11466__auto__ = f;
return (o__11466__auto__["toString"]).call(o__11466__auto__);
} else {
return "";
}
}catch (e12110){var _ = e12110;
return "";
}});
...
try{var o__11466__auto___12112 = t;
(o__11466__auto___12112["cljs$lang$ctorPrWriter"]).call(o__11466__auto___12112,t,writer);
}catch (e12111){var __12113 = e12111;
}
...
var char_code = (function (){var o__11466__auto__ = (new String(char$));
return (o__11466__auto__["charCodeAt"]).call(o__11466__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11466__auto__ = String;
return (o__11466__auto__["fromCharCode"]).call(o__11466__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12114 = num_code;
switch (G__12114) {
case (1):
return (185);
...
var o__11466__auto__ = String;
return (o__11466__auto__["fromCharCode"]).call(o__11466__auto__,superscript_code);
});
/**
...
}catch (e12116){var _e__11473__auto__ = e12116;
return false;
}})())){
...
var vec__12117 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12117,(0),null);
...
var len__4864__auto___12126 = arguments.length;
var i__4865__auto___12127 = (0);
while(true){
if((i__4865__auto___12127 < len__4864__auto___12126)){
args__4870__auto__.push((arguments[i__4865__auto___12127]));

var G__12128 = (i__4865__auto___12127 + (1));
i__4865__auto___12127 = G__12128;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12122){
var vec__12123 = p__12122;
var ns_detector = cljs.core.nth.call(null,vec__12123,(0),null);
...
var G__12129 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12130 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12129;
remaining_tokens = G__12130;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12120){
...
var vec__12134 = cljs.core.split_with.call(null,(function (p1__12133_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12133_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12134,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12134,(1),null);
...
var vec__12140 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12140,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12140,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12143 = cljs.core.rest.call(null,remaining_tokens);
var G__12144 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12143;
name_tokens = G__12144;
continue;
} else {
...
var vec__12147 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12147,(0),null);
var arity = cljs.core.nth.call(null,vec__12147,(1),null);
var vec__12150 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12150,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12150,(1),null);
var vec__12153 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12153,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12153,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12153,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12153,(3),null);
...
var vec__12159 = result;
var munged_ns = cljs.core.nth.call(null,vec__12159,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12159,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12159,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12159,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12159,(4),null);
var arity = cljs.core.nth.call(null,vec__12159,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__12163 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__12163,(0),null);
var args = cljs.core.nth.call(null,vec__12163,(1),null);
var vec__12166 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12166,(0),null);
var name = cljs.core.nth.call(null,vec__12166,(1),null);
...
var G__12169 = (arity + (1));
var G__12170 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12171){
var vec__12172 = p__12171;
var arity = cljs.core.nth.call(null,vec__12172,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12172,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12175_SHARP_){
return cljs.core.get.call(null,arities,p1__12175_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12176_SHARP_){
return cljs.core.drop.call(null,(2),p1__12176_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___12183 = arguments.length;
var i__4865__auto___12184 = (0);
while(true){
if((i__4865__auto___12184 < len__4864__auto___12183)){
args__4870__auto__.push((arguments[i__4865__auto___12184]));

var G__12185 = (i__4865__auto___12184 + (1));
i__4865__auto___12184 = G__12185;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12179){
var vec__12180 = p__12179;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12180,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12177){
var G__12178 = cljs.core.first.call(null,seq12177);
var seq12177__$1 = cljs.core.next.call(null,seq12177);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12178,seq12177__$1);
}));
...
var map__12188 = options;
var map__12188__$1 = cljs.core.__destructure_map.call(null,map__12188);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12188__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12188__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12188__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12188__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12189 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12189,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12189,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12189,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12189,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12189,(4),null);
var arity = cljs.core.nth.call(null,vec__12189,(5),null);
...
var o__11466__auto__ = f;
return (o__11466__auto__["getBasis"]).call(o__11466__auto__);
});
/**
...
}catch (e12192){var _e__11473__auto__ = e12192;
...
var G__12193 = (obj[cljs.core.first.call(null,path)]);
var G__12194 = cljs.core.rest.call(null,path);
obj = G__12193;
path = G__12194;
continue;
} else {
...
var _STAR_ = (function (accum,p__12195){
var vec__12196 = p__12195;
var bit = cljs.core.nth.call(null,vec__12196,(0),null);
var protocol = cljs.core.nth.call(null,vec__12196,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12199){
var vec__12200 = p__12199;
var ns = cljs.core.nth.call(null,vec__12200,(0),null);
var name = cljs.core.nth.call(null,vec__12200,(1),null);
var selector = cljs.core.nth.call(null,vec__12200,(2),null);
...
var post_process = (function (p__12204){
var vec__12205 = p__12204;
var munged_name = cljs.core.nth.call(null,vec__12205,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12205,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12203_SHARP_){
return (obj[cljs.core.first.call(null,p1__12203_SHARP_)]);
}),sorted_matches);
