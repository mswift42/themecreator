...
var G__12210 = devtools.prefs.pref.call(null,v);
v = G__12210;
continue;
} else {
return v;
...
}catch (e12211){var _e__11473__auto__ = e12211;
return false;
}})();
...
}catch (e12213){var _e__11473__auto__ = e12213;
return false;
}})();
...
}catch (e12215){var _e__11473__auto__ = e12215;
return false;
}}
}
});
...
var vec__12217 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12217,(0),null);
var name = cljs.core.nth.call(null,vec__12217,(1),null);
...
return cljs.core.some.call(null,(function (p1__12220_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12220_SHARP_);
}),template);
});
