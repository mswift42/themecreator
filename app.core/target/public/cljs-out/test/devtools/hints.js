...
var map__13226 = top_item;
var map__13226__$1 = cljs.core.__destructure_map.call(null,map__13226);
var file = cljs.core.get.call(null,map__13226__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13226__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13226__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e13225){var _e = e13225;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___13227 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___13227)){
var seen_errors_13228 = temp__5751__auto___13227;
if(cljs.core.truth_(seen_errors_13228.has(self))){
} else {
seen_errors_13228.add(self);

var temp__5753__auto___13229 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___13229)){
var sense_13230 = temp__5753__auto___13229;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13230)].join(''));
} else {
}
}
} else {
